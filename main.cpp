...
int main()
{
    ...
    else if (line[0] == '2')
    {
        Game g(10, 9);
        addStandardShips(g);
        Player* p2 = createPlayer("human", "chloe", g);
        Player* p1 = createPlayer("good", "zinnbae bot", g);
        g.play(p1, p2);
        delete p1;
        delete p2;
    }
    else if (line[0] == '3')
    {
        ...
        for (int k = 1; k <= NTRIALS; k++)
        {
            ...
            Game g(10, 10);
            addStandardShips(g);
            Player* p2 = createPlayer("good", "zinnbae", g);
            Player* p1 = createPlayer("mediocre",  "Mimi", g);
            Player* winner = (k % 2 == 1 ?
